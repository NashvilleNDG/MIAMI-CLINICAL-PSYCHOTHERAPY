# Google Search Console – Indexing Notes (Miami Clinical Psychotherapy)

Your sitemap and canonicals are correct (all URLs use `https://miamiclinicalpsychotherapy.com/` with **no www**). The remaining indexing issues are fixed by **server/hosting configuration** and GSC actions.
...
**URLs:**  
`http://www.miamiclinicalpsychotherapy.com/`  
`https://www.miamiclinicalpsychotherapy.com/`
...
- Add **301 redirects** so that:
  - `http://www.miamiclinicalpsychotherapy.com/*` → `https://miamiclinicalpsychotherapy.com/*`
  - `https://www.miamiclinicalpsychotherapy.com/*` → `https://miamiclinicalpsychotherapy.com/*`
...
**URL:**  
`http://miamiclinicalpsychotherapy.com/` (HTTP, no www)

**Cause:** Google crawled the **HTTP** URL. Your pages already have a canonical to `https://miamiclinicalpsychotherapy.com/`, which is correct.

**Fix:**

- On the server, add a **301 redirect**: `http://miamiclinicalpsychotherapy.com/*` → `https://miamiclinicalpsychotherapy.com/*`.
...
1. **Old URL `insurance-pricing.html`**  
   ...
   `https://miamiclinicalpsychotherapy.com/insurance-pricing.html` → `https://miamiclinicalpsychotherapy.com/pricing.html`  
...
2. **Other “Discovered - currently not indexed” URLs**  
   ...
   - Re-submit the sitemap: **Sitemaps** → submit `sitemap.xml` (or `https://miamiclinicalpsychotherapy.com/sitemap.xml`).
...
- [ ] In GSC, confirm the **property** is `https://miamiclinicalpsychotherapy.com` (no www).
- [ ] Resubmit **sitemap**: `https://miamiclinicalpsychotherapy.com/sitemap.xml`.
